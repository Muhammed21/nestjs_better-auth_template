...
/**
   ...
   * `prisma.designSystem`: Exposes CRUD operations for the **DesignSystem** model.
    ...
    * ```
    */
  get designSystem(): Prisma.DesignSystemDelegate<ExtArgs, { omit: OmitOpts }>;
   ...
   * `prisma.colorToken`: Exposes CRUD operations for the **ColorToken** model.
    ...
    * ```
    */
  get colorToken(): Prisma.ColorTokenDelegate<ExtArgs, { omit: OmitOpts }>;
